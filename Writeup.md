...
The [final model](https://github.com/pl80tech/CarND-Capstone/blob/master/ros/src/tl_detector/model/final/for_simulator.h5) I chose for submission is NVIDIA model (model #1 with dropout) trained with batch size 16, number of epoch 20 and combined dataset from dataset #1 ~ #9.
